                        ...
                        <div class="p-8 rounded-2xl bg-white border border-gray-200">
                            ...
                            <form class="mt-8 space-y-4" onSubmit={handleSubmit}>
                                ...
                                <div>
                                    ...
                                    <div class="relative flex items-center">
                                        <input maxLength="200" name="password" type={showPassword ? "text" : "password"} required class="w-full bg-gray-50 text-gray-900 2xl:text-sm xl:text-xs border border-gray-300 px-4 py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Enter password" />
                                        <svg onClick={handlePasswordToggle} xmlns="http://www.w3.org/2000/svg" fill="#6B7280" stroke="#6B7280" class="w-4 h-4 absolute right-4 cursor-pointer" viewBox="0 0 128 128">
                                ...
                                <div class="flex flex-wrap items-center justify-between gap-4">
                                    <div class="2xl:text-sm xl:text-xs">
                                        <a href="/reset-password" class="text-blue-500 hover:underline font-semibold">
                                ...
                                <p class="text-gray-600 2xl:text-sm xl:text-xs !mt-8 text-center">Don't have an account? <a href="/register" class="text-blue-500 hover:underline ml-1 whitespace-nowrap font-semibold">Register here</a></p>
                            </form>
                        </div>
                    </div>
                </div>
